...
from admin.database_view import CommonDatabase, MetaDatabase, LangDatabase, ImageFileDatabase
...
def init_console(app, db):
    ...
    console.add_view(ImageFileDatabase(AkoImage, db.session, category=Cats.databases))
    console.add_view(CommonDatabase(AkoArticle, db.session, category=Cats.databases))
    console.add_view(CommonDatabase(AkoTag, db.session, category=Cats.databases))
